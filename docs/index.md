...
The following example analysis demonstrates a way in which sex-and gender-based analysis (SGBA) can be conducted using results from the Sex- and Gender-Based Analysis Tool – 5 item (SGBA-5) by Putman and Dogra which can be downloaded [here](https://doi.org/10.1371/journal.pone.0323834.s001). The SGBA-5 is free to use and is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
