...
# density plot
pos_cont_sex_dens <- ggplot(sim_data, aes(x = outcome_num_pos_sex, fill = bio_sex)) + 
...
pos_cont_sex_sum   # view stats

# t test
con_sex_ttest <- t.test(outcome_num_pos_sex ~ bio_sex, data = sim_data)
