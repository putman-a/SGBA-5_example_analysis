...
knitr::kable(pos_cont_sex_sum, booktabs = TRUE, caption = "Interaction example summary statisitics: Continuous outcome and biological sex")
```
...
knitr::kable(neg_cont_sex_sum, booktabs = TRUE, caption = "No interaction example summary statisitics: Continuous outcome and biological sex")
```
...
```{r 04-2gah-2ddens, fig.cap="2D Density Plots of Continuous Variable by Gender Identity and Gendered Roles", fig.width=3.5, fig.height=3.5, fig.align='center',fig.show='hold', out.width = '50%', echo=FALSE}
# 2d density plot - interaction
ggplot(data = sim_data, aes(x = gen_id, y = outcome_num_pos_gid)) + 
  geom_density_2d_filled(
    aes(fill = after_stat(level)), bins = 9, contour_var = 'ndensity'
